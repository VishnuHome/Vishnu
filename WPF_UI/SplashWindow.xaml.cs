...
namespace NetEti.CustomControls
{
    ...
    public partial class SplashWindow : Window, INotifyPropertyChanged
    {
        ...
        private SplashWindow()
        {
            ...
            this._showboard = this.Resources["showStoryBoard"] as Storyboard;
            this._hideboard = this.Resources["HideStoryBoard"] as Storyboard;
            this._fadeoutboard = this.Resources["SplashWindowFadeOutStoryBoard"] as Storyboard;
        }
