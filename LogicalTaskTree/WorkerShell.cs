...
namespace LogicalTaskTree
{
    ...
    public class WorkerShell : NodeShellBase, INodeWorker
    {
        ...
        public void Exec(TreeParameters treeParameters, string nodeId, TreeEvent eventParameters, bool isResetting)
        {
            ...
            if (winPoint.X > AppSettings.ActScreenBounds.Right - 100)
            {
                winPoint.X = AppSettings.ActScreenBounds.Right - 100;
            }
            if (winPoint.Y > AppSettings.ActScreenBounds.Bottom - 70)
            {
                winPoint.Y = AppSettings.ActScreenBounds.Bottom - 70;
            }
