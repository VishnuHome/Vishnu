...
namespace LogicalTaskTree
{
    ...
    public abstract class NodeParent : LogicalNode
    {
        ...
        public NodeParent(LogicalNode mother, JobList rootJobList) : base(mother, rootJobList)
        {
        ...
        protected virtual void SubNodeStateChanged(object sender, NodeState state)
        {
            ...
            {
                // Statistics.Inc(String.Format("#SUB# {0}/{1}: NodeParent.SubNodeStateChanged", this.Id, this.Name));
