...
namespace Vishnu.DemoApplications.SingleNodeUserControlDemo
{
    ...
    /// </remarks>
    public class DemoSingleNodeViewModel : VishnuViewModelBase
    {
        /// <summary>
        ...
        public DemoSingleNodeViewModel() : base()
        {
            ...
            this._result = new Result("TestResult", true, NodeState.Finished, NodeLogicalState.Done, this._returnObject);
            this.RaisePropertyChanged(nameof(Result));
        }
        ...
        private ComplexReturnObject _returnObject;
        ...
        private async void runTaskTreeExecute(object? parameter)
        {
            ...
            {
                ComplexReturnObject newResult = (ComplexReturnObject)this.Result.ReturnObject;
                newResult.TestProperty2 = result;
                this.RaisePropertyChanged(nameof(Result));
                this.RaisePropertyChanged(nameof(ShortResult));
            }
        }
