...
namespace Vishnu.DemoApplications.ConstantNodeUserControlDemo
{
    ...
    /// </remarks>
    public class DemoConstantNodeViewModel : VishnuViewModelBase
    {
        /// <summary>
        ...
        /// </summary>
        public DemoConstantNodeViewModel()
        {
        ...
        public void RaiseAllProperties()
        {
            ...
            this.RaisePropertyChanged(nameof(ButtonRunText));
            this.RaisePropertyChanged(nameof(ButtonBreakText));
            this.Logical = !this.Logical;
        }

        private Result? _result;
        private string? _returnObject;
